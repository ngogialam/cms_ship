        ...
        <ul class="or-dgh col-12">
            ...
            <li class="or-ttnh">
                ...
                <ul class="row">
                    ...
                    <li class="col-md-3 col-sm-6 or-cgc-1">
                        <input type="checkbox" class="regular-checkbox" style="width: 10px;height: 10px;"> Giá trị khai
                        giá<span style="color: #885DE5;">*</span> <br>
                ...
                <ul class="row">
                    <li class="col-md-6 col-sm-12">
                        ...
                        <datalist id="loai-hh">
                            ...
                            <option value="Loại hàng hóa"></option>
                            <option val ue="Loại hàng h óa"></option>
                        </datalist>
