        ...
        <div class="col-md-6 col-sm-12 or-ttng-right">
            ...
            <ul>
                <li>
                    ...
                    <span style="float: right;"><input type="checkbox" style="width: 10px; height: 10px;"> Lưu kho
                        mới</span>
                </li>
                <li>
    ...
    <div class="or-ttdh row">
        ...
        <ul class="or-dgh col-12">
            <li class="or-dgh-1" style="margin-top: -17px">
                <span class="or-dh-stt">2</span> Thêm đơn hàng chi tiết
            </li>
            <li class="or-ttnh">
                <ul>
                    <li class="or-ttnh-tt">
            ...
            <li class="or-ttnh">
                ...
                <ul class="row">
                    ...
                    <li class="col-md-3 col-sm-6 or-cgc-1">
                        <input type="checkbox" style="width: 10px;height: 10px;"> Giá trị khai giá<span
                ...
                <ul class="row">
                    <li class="col-md-6 col-sm-12">
                        ...
                        <input list="loai-hh" name="loai-hh" style="padding-right: 10px;" placeholder="Loại hàng hóa">
                        <datalist id="loai-hh">
            ...
            <li>
                <ul>
                    <li>
                        ...
                        <input type="text" placeholder="Nhập ghi chú thêm" style="width: 97.5%;" class="or-ttnh-input1">
                    </li>
                </ul>
            </li>
        </ul>
        ...
        <ul class="col-xl-2 col-sm-3 or-ctdh-1 or-ctdh-2">
            <li>
                <ul>
                    <li class="or-cgc-1">
                        Dịch vụ thêm <br>
                        <input type="checkbox" class="or-radio-checked" /> Giao tận tay <br>
                        <input type="checkbox" class="or-radio-checked" /> Bốc dỡ
                    </li>
                </ul>
            </li>
        </ul>
