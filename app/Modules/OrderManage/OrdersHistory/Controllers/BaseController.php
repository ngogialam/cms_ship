...
use App\Modules\OrderManage\Common\Models\SingleModels;
use App\Modules\OrderManage\SingleOrder\Models\SingleOrderModel;
use App\Modules\OrderManage\Common\Models\MultipleOrdersModels;
...

{
	...
	public function initController(\CodeIgniter\HTTP\RequestInterface $request, \CodeIgniter\HTTP\ResponseInterface $response, \Psr\Log\LoggerInterface $logger)
	{
        ...
        $this->common = new MultipleOrdersModels();
		// E.g.:
