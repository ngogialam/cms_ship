...
use App\Modules\SecurityManage\Controllers\SecurityManage;
use App\Modules\SecurityManage\Models\SecurityManageModels as SecurityManageModels;
...

{
	...
	public function initController(\CodeIgniter\HTTP\RequestInterface $request, \CodeIgniter\HTTP\ResponseInterface $response, \Psr\Log\LoggerInterface $logger)
	{
		...
		$this->SecurityManageModels = new SecurityManageModels($logger);
	}
}