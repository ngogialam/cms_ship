      ...
      <div>
        <ul class="list-unstyled mb-0">
          ...
          <li class="cn-otp-txt pl-0 ">
            ...
            <span><?= lang('Label.lbl_False') ?></span><br>
            <?= $dataOld->message ?><br>
            <?= lang('Label.lbl_tryAgainPls') ?>
          </li>
          ...
          <li>
            <a href="<?= base_url($lang.'/them-lien-ket/1') ?>">
              <button class="cn-bank-btn text-center"><?= lang('Label.lbl_tryAgain') ?></button></a>
          </li>
        </ul>
      </div>
    </div>
