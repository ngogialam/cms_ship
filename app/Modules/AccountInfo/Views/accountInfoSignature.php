    ...
    <form action="" class="form-100 edit-account-info" id="form-user-info" method="POST" enctype="multipart/form-data">
        <section id="info-detail" class="row w-100 signature-detail">
                ...
                <div class="h-100 pb30">
                    ...
                    <div class="img-signature-2">
                        <label for="imgSignature">
                            <img for="imgSignature" class="imgSignaturePreview " style="width:80px;"
                            src="<?= base_url('public/images/add-img-signature.svg'); ?>" data-typeImg="1" alt="">
                        </label>
                        <input type="hidden" class="typeImage" value="">
                        
                        <input type="file" name="imgSignature" class="imgDefault imgSignature"
                        onchange="loadFile(event,'imgSignatureImg','err_imgSignatureErr',1)" id="imgSignature" />
                        <p class="err_messagesp err_imgSignatureErr"> <?php echo $getErrors['imgSignature'] ?>
                        
                        <input type="hidden" name="imgSignatureValue" value="">
                        <input type="hidden" class="imgSignaturePath" name="imgSignaturePath" value="">
                        <input type="hidden" class="imgSignatureType" name="imgSignatureType" value="1">
                        </p>
                    </div>
                    <div class=" pt-2 pb-2">
                        </br>
                ...
                <div class="pb30">
                    ...
                    <div class="img-signature-2">
                        ...
                        <div class="w-100 btn-signature">
                            ...
                            <button type="button" class="btn-signature-xn btnZoomIn" id="btnZoomIn" title="Phóng to">
                                <span class="fa fa-search-plus"></span>
                                </span>
                            </button>
                            <button type="button" class="btn-signature-xn btnZoomOut" id="btnZoomOut" title="Thu nhỏ">
            ...
            <div class="btn-submit-signature text-center col-12">
                <button style="margin:0 auto; margin-top:15px;" type="button" class="form-control frm-lg info-button btnImgSignature " disabled >Hoàn thành</button>
            </div>
        </section>
    </form>
    <section>