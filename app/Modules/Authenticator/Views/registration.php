        ...
        <div class="row">
            <div class="col-lg-4 col-md-6 col-sm-12 col-xs-8 ml-auto login-form">
                ...
                <form action="" id="form-search-user" method="POST" enctype="multipart/form-data">
                    ...
                    <div class=" ">
                        <input class="form-control frm-lg  validatePass" id="password" autocomplete="off"
                            value="<?php echo $listValues['password']; ?>"
                    ...
                    <div class=" ">
                        <input class="form-control frm-lg pass_log_id" id="repassword"
                            value="<?php echo $listValues['rePassword']; ?>"
                            data-msg="<?= lang('Label.lbl_checkChars') ?>"
                    ...
                    <label style="padding-left: 10px;">
                        ...
                        <p class=" err_messages ">
                            <?php echo \Config\Services::validation()->showError('legalsAndRules'); ?></p>
                    </label>
                    <div class="btn-login">
                        <button type="submit" name="register" value="1"
                            class="btn form-control btn-register btn-primary">
